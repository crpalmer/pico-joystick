...
class GamePad *pico_joystick_on_boot(const char *hostname, GPInput *bootloader_button, int wakeup_gpio, GPOutput *power_led = NULL, GPOutput *bluetooth_led = NULL, GPInput *wakeup_button = NULL);
